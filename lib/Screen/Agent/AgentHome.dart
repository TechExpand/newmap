...
import 'package:newmap/Screen/Agent/Recycle.dart';
...
import 'AgentTab.dart';

class AgentHomePage extends StatefulWidget {
  const AgentHomePage({Key? key}) : super(key: key);

  @override
  _AgentHomePagePageState createState() => _AgentHomePagePageState();
}

class _AgentHomePagePageState extends State<AgentHomePage> {
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  //       height: 40,
                                  //       width: 40,
                                  //       child: Image.asset('assets/images/edo.png', )),
                                  // ),
                                  RichText(
                                    text: TextSpan(
                                      text: 'ID: ',
            ...
            InkWell(
              onTap: () {
                Navigator.push(
                  ...
                  PageRouteBuilder(
                    pageBuilder: (context, animation, secondaryAnimation) {
                      return BankDetails(agent:'agent');
                    },
                    transitionsBuilder: (context, animation, secondaryAnimation, child) {
                      return FadeTransition(
                        opacity: animation,
            ...
            InkWell(
              onTap: ()async{
                Navigator.push(
                  ...
                  PageRouteBuilder(
                    pageBuilder: (context, animation, secondaryAnimation) {
                      return AirtimeDetails(bank: false, info: null, title: null, agent:'agent');
                    },
                    transitionsBuilder: (context, animation, secondaryAnimation, child) {
                      return FadeTransition(
                        opacity: animation,
            ...
            InkWell(
              onTap: ()async{
                Navigator.push(
                  ...
                  PageRouteBuilder(
                    pageBuilder: (context, animation, secondaryAnimation) {
                      return AirtimeDetails(bank: false, info: null, title: null,gift: true, agent:'agent');
                    },
                    transitionsBuilder: (context, animation, secondaryAnimation, child) {
                      return FadeTransition(
                        opacity: animation,
