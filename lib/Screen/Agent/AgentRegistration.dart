...
class AgentRegsiter extends StatefulWidget {
  const AgentRegsiter({Key? key}) : super(key: key);

  @override
  _AgentRegsiterState createState() => _AgentRegsiterState();
}

class _AgentRegsiterState extends State<AgentRegsiter> {
  ...
  Widget build(BuildContext context) {
    LgaProvider lga =  Provider.of<LgaProvider>(context, listen: false);
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Align(
                    ...
                    child: Text("Create Agent Account", style: TextStyle(color: Color(0xFF353535),
                        fontSize: 24,
                ...
                Padding(
                  ...
                  child: Align(
                      ...
                      child: Text('Business Name', style: TextStyle(color: Color(0xFF141414).withOpacity(0.35),),)),
                ),
                Container(
                ...
                Padding(
                  ...
                  child: Align(
                      alignment: Alignment.bottomLeft,
                      child: Text('Unique ID', style: TextStyle(color: Color(0xFF141414).withOpacity(0.35),),)),
                ),
                Container(
                    margin: const EdgeInsets.symmetric(horizontal: 20,),
                    child: TextFormField(
                      onChanged: (value){
                        provide.uniqueID = value;
                      },
                      validator: (value){
                        if(value!.isEmpty){
                ...
                Padding(
                  ...
                  child: Align(
                      alignment: Alignment.bottomLeft,
                      child: Text('Shop Location', style: TextStyle(color: Color(0xFF141414).withOpacity(0.35),),)),
                ),
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async{
                      ...
                      if(formKey.currentState!.validate()){
                        ...
                        // else if(lga.seletedinfo==null){
                        //   await showTextToast(
                        //     text: 'pleease select your Local Government Area.',
                        //     context: context
                        //   );
                        // }
                        ...
                        await showTextToast(
                            text: 'field cannot be empty. check all field.',
                            context: context
                        );
                      }
                    },
